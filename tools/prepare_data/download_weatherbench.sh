...
wget --no-check-certificate "https://dataserv.ub.tum.de/s/m1524895/download?path=%2F5.625deg%2Ftotal_cloud_cover&files=total_cloud_cover_5.625deg.zip" -O total_cloud_cover_5.625deg.zip
