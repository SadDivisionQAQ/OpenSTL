...
wget --no-check-certificate "https://dataserv.ub.tum.de/s/m1524895/download?path=%2F5.625deg&files=10m_v_component_of_wind&downloadStartSecret=bb37774bc07" -O 10m_v_component_of_wind_5.625deg.zip
